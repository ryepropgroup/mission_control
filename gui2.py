...
class Ui_MainWindow(object):
    ...
    def __init__(self, MainWindow):
        ...
        self.time_label.setGeometry(QtCore.QRect(330, 150, 151, 31))
        font = QtGui.QFont()
        ...
        self.fileState.setGeometry(QtCore.QRect(350, 110, 100, 21))
        font.setFamily("Helvetica")
        ...
        self.fileState.setStyleSheet("color: red; font-size: 16px;") 
...
#20, 500, 90, 55
    ...
    def on_data_ready(self,data):
        try:
                ...
                if str(v_ign) == "True": 
                    self.ignOPEN.setStyleSheet("QPushButton { background-color: #808080; color: white; }")
                    self.ignCLOSE.setStyleSheet("QPushButton { background-color: red; color: white; }")

                elif str(v_ign) == "False":
                    self.ignOPEN.setStyleSheet("QPushButton { background-color: #12b81b; color: white; }")
                    self.ignCLOSE.setStyleSheet("QPushButton { background-color: #808080; color: white; }")
                ...
                try:
                    ...
                    self.sign.setText(self.translateState(str(v_ign)))
    ...
    def translateFileState(self, string): 
        if string == "False": 
            field = "Not Writing"
            return field
        elif string == "True": 
